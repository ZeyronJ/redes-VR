...
public class CableComponent : MonoBehaviour
{
	...
	// Cable config
	[SerializeField] public float cableLength = 0.5f;
	[SerializeField] public int totalSegments = 5;
	[SerializeField] public float segmentsPerUnit = 2f;
    public int segments = 0;
	[SerializeField] public float cableWidth = 0.1f;

	// Solver config
	[SerializeField] public int verletIterations = 1;
	...
	{
        line = this.GetComponent<LineRenderer>(); // Intenta obtener el LineRenderer existente
        if (line == null)
        {
            line = this.gameObject.AddComponent<LineRenderer>(); // Si no existe, agrégalo
        }
